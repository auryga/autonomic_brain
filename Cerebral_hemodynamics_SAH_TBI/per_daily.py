# -*- coding: utf-8 -*-
"""
Created on Fri Oct 15 20:16:29 2021
...
SOURCE_FILE_PATH = "C:\Moje_dokumenty\Po_doktoracie_09_2021\Tau_DCI\wyniki_daily"
...
for n in range (0,files_number):
    pusta_macierz.values[n] = results_final.values[n]
...
#concatenate with sides of vasospasm
df_merged = pd.concat([pusta_macierz,side], axis=1)

#saving results
df_merged.to_csv(SOURCE_FILE_PATH + '/' +'results.csv', sep = ';', index = False)